      ...
      children: [
        ...
        Row(
          children: [
            Padding(
              ...
              child: Text("2. WHY TAKE PAYMENTS: ",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
        ...
        Row(
          children: [
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("3. THIS PAYMENT IS REFUNDABLE: ",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
        ...
        Row(
          children: [
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("4.WHAT IS THE MEANING OF “INSTANT”: ",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
        ...
        Row(
          children: [
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("5. STUDENT LOAN PROCESS: ",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
        ...
        Row(
          children: [
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("6. BUSINESS LEADS:",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
        ...
        Row(
          children: [
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("7. ELIGIBILITY CRITERIA:",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
        ...
        Row(
          children: [
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("8. BAD/LOW CIBIL/CREDIT SCORE: ",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
        ...
        Row(
          children: [
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("SUGGESTION FOR LOW/BAD CIBIL: ",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
        ...
        Row(
          children: [
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("9. PRIVATE LOAN/DAILY BASIS LOAN: ",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
        SizedBox(
          ...
          children: [
            Padding(
              ...
              child: MaterialButton(
                onPressed: (){
                  Navigator.pushAndRemoveUntil(context, CupertinoPageRoute(builder: (context)=>RegistrationPage()), (route) => false);
                },
                child: Text("AGREE",style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),),
                color: yellowColor,
                minWidth: 100,
              ),
            ),
